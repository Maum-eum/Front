...
const Steps: React.FC<StepsProps> = ({ step = 1 }) => {
  return (
    <div className="flex font-pre-M text-base justify-center items-center gap-4 w-full font-gtr-B">
      {/* 1단계 */}
      <div className={clsx("w-12 h-12 rounded-full flex justify-center items-center text-white font-gtr-B", 
